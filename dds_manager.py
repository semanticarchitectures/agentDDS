...
class DDSManager:
    ...
    def __init__(self, gateway_config: GatewayConfig, types_config: TypesConfig):
        ...
        self.topics: Dict[str, dds.Topic] = {}
        self.data_readers: Dict[str, dds.DataReader] = {}
        self.data_writers: Dict[str, dds.DataWriter] = {}
        self.subscriptions: Dict[str, SubscriptionHandle] = {}

        self._running = False
        self._waitset: Optional[dds.WaitSet] = None
    ...
    def create_topic(self, topic_name: str) -> dds.Topic:
        """
